    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content pt-4 pb-4 ps-4 pe-4">
            ...
            <div class="modal-header border-0">
                <h5 class="modal-title text-center" id="myModalLabel">Join our newsletter to recceive the latest updates
                    promotions.</h5>
                <button type="button" class="btn-close cus_closebtn  " data-bs-dismiss="modal"
                ...
                <form id="subscribe-form">
                    ...
                    <div class="input-group">
                      ...
                      <p>Loading...</p> <!-- You can replace this with an actual loader image or animation -->
                        ...
                        <input type="email" class="cus_form-control form-control" name="email"
                            placeholder="Your Email" required>
                        <button type="submit" class="btn btn-danger btn-default">

                            <span id="loader" class="spinner-border spinner-border-sm text-white" text-whote
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-3">
                ...
                <form class="mt-3" id="subscribe-form2">
                    <div class="input-group">
                        <input type="text" class="cus_form-control form-control" name="email2"
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        const errorMessage =
                            `<div class="alert alert-danger" role="alert">${errors.email[0]}</div>`;
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  const successMessage2 =
                        `<div class="alert alert-success" role="alert">${response.message}</div>`;
                    $('#contactform_msg_cont').html(successMessage2).show();

                    setTimeout(() => {
                      $('#contactform_msg_cont').html(successMessage2).fadeOut();
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        const errorMessage =
                            `<div class="alert alert-danger" role="alert">${errors.email[0]}</div>`;
                        $('#contactform_msg_cont').html(errorMessage).show();
                    } else {
                        const generalError =
                            `<div class="alert alert-danger" role="alert">An error occurred. Please try again.</div>`;
                        $('#contactform_msg_cont').html(generalError).show();
                    }
                }
            });
        });
